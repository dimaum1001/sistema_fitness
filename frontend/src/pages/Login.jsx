    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-blue-800 px-4">
      <div className="bg-white shadow-xl rounded-2xl p-8 w-full max-w-lg">
        <div className="text-center mb-6">
          ...
          <h1 className="text-3xl font-bold text-slate-900 mt-1">Login</h1>
          <p className="text-sm text-slate-500 mt-1">Entre como admin, professor ou aluno usando email e senha.</p>
        </div>
