  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-100 px-4">
      <div className="bg-white shadow-xl rounded-xl p-8 w-full max-w-lg">
        <h1 className="text-2xl font-bold text-slate-900 mb-2">Cadastro de Professor</h1>
        <p className="text-sm text-slate-600 mb-4">Use este fluxo apenas para testes do MVP.</p>
